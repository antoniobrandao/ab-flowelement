...
module.exports = {
    ...
    addElements: function(element_class, options)
    {
      ...
      // elements_array.push({ element: el, options: options })
      //,


      // Make the magic visible
      // ======================
      return $(element_class).each(function() {
      // Context for resize callback
         var that = this;
      // Make changes upon resize
         $(window).resize(function(){changes(that, settings);});
      // Make changes upon orientation change
         window.addEventListener('orientationchange', changes(that, settings));
      // Set changes on load
...
// Do the magic math
// =================
var changes = function(el, settings) 
{
